...
for i=1:10
    s=find(gnd==i);
    feank(1+100*(i-1):100*i,:)=fea(s(1:100),:);
    gndnk(1+100*(i-1):100*i,:)=i;
end
feank=im2double(feank);%将数据归一化到0-1之间
feank = NormalizeFea(feank); 
%gndnk=gndnk;%变成1-10，而不是0-9
X=feank';
C=10; 
m=1000;
n=3072;
    ...
    for K=K_search
        clear res
            ...
            para.lambda2=1000;
                ...
                [Xiter1,gnditer1]=randpermData1(feank,gndnk,C,m,l);                
...
% L1=A1-W1;
            ...
            for cn=1:10%迭代十次结果
                ...
                [U,V]=DABNMTFSV(Xiter,P1,P2,para,L2,l);%双边
                H=V;
                Hnew=H(l+1:end,:);
                nClass=C;
