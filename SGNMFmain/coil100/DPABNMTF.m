function [U,V,obj]=DPABNMTF(X,P1,P2,para,L2,l)
% X in d \times N
...
%     % U=(U+abs(U))/2;
% 
%     Z1=(Z1'*P1'+0.8*pinv(P2*Z2)*(X'-P2*Z2*Z1'*P1')/norm(P2*Z2,'fro'))*pinv(P1');
%     Z1=Z1';
%     Z1=(Z1+abs(Z1))/2;
%     Z2=pinv(P2)*(P2*Z2+0.8*(X'-P2*Z2*Z1'*P1')*pinv(Z1'*P1')/norm(Z1'*P1','fro'));
%     Z2=(Z2+abs(Z2))/2;
%     %停止条件
