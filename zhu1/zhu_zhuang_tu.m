...
num=readmatrix('D:\graduate\matlab\NMF\create\ENMF\zhu1\yale.xlsx') ;
...
figure('position',[150,100,750,650]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%coil20
num=readmatrix('D:\graduate\matlab\NMF\create\ENMF\zhu1\coil20.xlsx') ;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%coil100
%num=readmatrix('D:\graduate\matlab\NMF\DABNMTF-main\zhu\coil20.xlsx') ;
num=readmatrix('D:\graduate\matlab\NMF\create\ENMF\zhu1\coil100.xlsx') ;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%FERET
%num=readmatrix('D:\graduate\matlab\NMF\DABNMTF-main\zhu\coil20.xlsx') ;
num=readmatrix('D:\graduate\matlab\NMF\create\ENMF\zhu1\FERET.xlsx') ;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%GT
%num=readmatrix('D:\graduate\matlab\NMF\DABNMTF-main\zhu\coil20.xlsx') ;
num=readmatrix('D:\graduate\matlab\NMF\create\ENMF\zhu1\GT.xlsx') ;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%ORL
%num=readmatrix('D:\graduate\matlab\NMF\DABNMTF-main\zhu\coil20.xlsx') ;
num=readmatrix('D:\graduate\matlab\NMF\create\ENMF\zhu1\ORL.xlsx') ;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%PIE
%num=readmatrix('D:\graduate\matlab\NMF\DABNMTF-main\zhu\coil20.xlsx') ;
num=readmatrix('D:\graduate\matlab\NMF\create\ENMF\zhu1\PIE.xlsx') ;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Umist
%num=readmatrix('D:\graduate\matlab\NMF\DABNMTF-main\zhu\coil20.xlsx') ;
num=readmatrix('D:\graduate\matlab\NMF\create\ENMF\zhu1\Umist.xlsx') ;
